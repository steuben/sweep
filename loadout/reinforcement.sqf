...
if (!alive steuben2) then {
	"ACE_USMC_SoldierM_Marksman_D" createUnit [_spawnPos, alpha, "steuben2=this", 1, ""];
};

if (!alive steuben3) then {
	"ACE_USMC_Soldier_TAR_D" createUnit [_spawnPos, alpha, "steuben3=this", 1, ""];
};

if (!alive steuben4) then {
	"ACE_USMC_Soldier_AT_D" createUnit [_spawnPos, alpha, "steuben4=this", 0.8, ""];
};
...
if (!alive bbq2) then {
	"ACE_USMC_SoldierM_Marksman_D" createUnit [_spawnPos, bravo, "bbq2=this", 1, ""];
};

if (!alive bbq3) then {
	"ACE_USMC_Soldier_TAR_D" createUnit [_spawnPos, bravo, "bbq3=this", 1, ""];
};

if (!alive bbq4) then {
	"ACE_USMC_Soldier_D" createUnit [_spawnPos, bravo, "bbq4=this", 0.8, ""];
};
